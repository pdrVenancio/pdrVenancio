<img src="https://capsule-render.vercel.app/api?type=waving&height=200&text=Pedro%20Venâncio&textBg=false&desc=Desenvolvedor%20full-stack&descAlign=50&descAlignY=53&fontAlign=50&fontAlignY=32&stroke=ffffff&strokeWidth=0&reversal=true" width="100%"/>
👩‍💻 Trabalho atualmente utilizando C# (.NET), TypeScript (Angular), MongoDB, Tailwind.

🧠 7º periodo do curso de Sistema de informação na UNIFEI.
